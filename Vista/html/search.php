...
<body>
    ...
    <table class="tabla-usuarios">
        ...
        $total_registro=$result_register['total_registro'];
            ...
            $sentence="SELECT id, nombre, usuario, rol, tipoId, direccion, telefono, correo FROM usuario WHERE id LIKE '%$search%' OR nombre LIKE '%$search%' OR usuario LIKE '%$search%' OR rol LIKE '%$search%' OR tipoId LIKE '%$search%' OR direccion LIKE '%$search%' OR telefono LIKE '%$search%' OR correo LIKE '%$search%' ORDER BY nombre LIMIT $desde, $por_pagina";
        ...
        ?>
                <tr>
                    ...
                    <td><a href="delete_user.php?usr=<?php echo $rows['id'] ?>"><input class="btn-eliminar" type="button" value="Eliminar"></a></td>
                </tr>
        <?php
            }
