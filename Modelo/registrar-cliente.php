...
<body>
   ...
   <div class="registro-cliente"><h1>REGISTRAR CLIENTE</h1></div>
   <div class="formulario-registro-cliente">
       <form action="">
            ...
            <input class="control-registro" type="text"><br><br>
            <a href="javascript:abrir5()"><input class="boton-agregar2" type="button" value="AGREGAR"></a>
            <a href="clientes.html"><input class="boton-cancelar2" type="button" value="CANCELAR"></a>
       </form>
       
   </div>
   <section>
    <div class="cliente-agregado" id="cliente-agregado">
        <h1>CLIENTE REGISTRADO CON EXITO¡¡¡</h1>
        <a href="registrar-cliente.html"><img src="/img/ACEPTAR.png" alt="ACEPTAR" width="20%"></a>
    </div>
    </section>

    <script>
        function abrir5(){
                document.getElementById("cliente-agregado").style.display="block";
            }
    </script>
